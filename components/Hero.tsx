    ...
    <section className="max-container padding-container flex flex-col gap-20 py-20 md:gap-28 pt-40 xl:flex-row">
      ...
      <div className="relative z-20 flex flex-1 flex-col xl:w-1/2">
        ...
        <p className="regular-16 mt-6 text-gray-30 xl:max-w-[520px]">
          ...
          seeing the incorruptible beauty of nature. We provide a solution for
          you to be able to use our application when climbing, yes offline maps
          you can use at any time there is no signal at the location.
        </p>
